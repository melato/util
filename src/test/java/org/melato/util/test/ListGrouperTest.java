...
public class ListGrouperTest {
  static class StringGrouper extends AbstractListGrouper<String> {
    private List<String[]> groups = new ArrayList<String[]>();
    
    protected void addGroup(List<String> group) {
  ...
  static class SequenceGrouper extends AbstractListGrouper<Integer> {
    private List<int[]> groups = new ArrayList<int[]>();
    
    protected void addGroup(List<Integer> group) {
      groups.add(IntArrays.toArray(group));
    }
